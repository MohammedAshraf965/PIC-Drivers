...
# 1 "MCAL_Layer/ADC/../GPIO/../Platform_Types.h" 1
# 34 "MCAL_Layer/ADC/../GPIO/../Platform_Types.h"
...
# 37 "MCAL_Layer/ADC/../GPIO/../mcal_std_types.h"
...
# 41 "MCAL_Layer/ADC/../GPIO/hal_gpio.h"
typedef enum
{
    GPIO_LOW = 0,
    GPIO_HIGH
...
# 13 "MCAL_Layer/ADC/../Interrupt/mcal_interrupt_manager.h"
# 1 "MCAL_Layer/ADC/../Interrupt/mcal_interrupt_config.h" 1
# 13 "MCAL_Layer/ADC/../Interrupt/mcal_interrupt_manager.h" 2
...
void TMR0_ISR(void);
# 17 "MCAL_Layer/ADC/../Interrupt/mcal_interrupt_config.h" 2
...
# 66 "MCAL_Layer/ADC/../Interrupt/mcal_internal_interrupt.h"
...
static __attribute__((inline)) void ADC_Input_Channel_Port_Configure(adc_channel_pin_t channel);
static __attribute__((inline)) void ADC_Select_Result_Format(const adc_conf_t *adc_obj);
static __attribute__((inline)) void ADC_Set_Voltage_Mode(const adc_conf_t *adc_obj);
...
static ADCInterruptHandler ADC_InterruptHandler = ((void*)0);
...
Std_ReturnType ADC_GetConversionResult(const adc_conf_t *adc_obj, adc_result *conversion_result)
{
    ...
    if((adc_obj == ((void*)0)) || (conversion_result == ((void*)0)))
    {
        ret = (Std_ReturnType)0x01;
    }
    else
    {
        if(adc_obj -> result_format == 0x01)
        {
            *conversion_result = (adc_result)((ADRESH << 8) + ADRESL);
        }
        else if(adc_obj -> result_format == 0x00)
        {
