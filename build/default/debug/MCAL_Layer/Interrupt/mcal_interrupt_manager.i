...
# 49 "MCAL_Layer/Interrupt/mcal_interrupt_manager.c"
void __attribute__((picinterrupt(("")))) InterruptManager(void)
{
    if((INTCONbits.INT0IE == 0x01U) && (INTCONbits.INT0IF == 0x01U))
    {
      INT0_ISR();
    }
    else { }

    if((INTCON3bits.INT1IE == 0x01U) && (INTCON3bits.INT1IF == 0x01U))
    {
      INT1_ISR();
    }
    else { }

    if((INTCON3bits.INT2IE == 0x01U) && (INTCON3bits.INT2IF == 0x01U))
    {
      INT2_ISR();
    }
    else { }

    if((INTCONbits.RBIE == 0x01U) && (INTCONbits.RBIF == 0x01U) && (PORTBbits.RB4 == GPIO_HIGH))
    {
      RB4_ISR();
    }
    else { }

      if((INTCONbits.RBIE == 0x01U) && (INTCONbits.RBIF == 0x01U) && (PORTBbits.RB4 == GPIO_LOW))
    {
      RB4_ISR();
    }
    else { }

    if((INTCONbits.RBIE == 0x01U) && (INTCONbits.RBIF == 0x01U))
    {
      RB5_ISR();
    }
    else { }
    ...
    if((PIE1bits.ADIE == 0x01U) && (PIR1bits.ADIF == 0x01U))
    {
      ADC_ISR();
    }
    else { }

    if((INTCONbits.TMR0IE == 0x01U) && (INTCONbits.TMR0IF == 0x01U))
    {
      TMR0_ISR();
    }
    else { }
