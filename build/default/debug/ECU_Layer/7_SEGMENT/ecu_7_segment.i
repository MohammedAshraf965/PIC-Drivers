...
# 10 "ECU_Layer/7_SEGMENT/ecu_7_segment.c"
...
# 1 "ECU_Layer/7_SEGMENT/../../MCAL_Layer/GPIO/../Platform_Types.h" 1
# 34 "ECU_Layer/7_SEGMENT/../../MCAL_Layer/GPIO/../Platform_Types.h"
...
# 14 "ECU_Layer/7_SEGMENT/ecu_7_segment.h" 2
...
# 10 "ECU_Layer/7_SEGMENT/ecu_7_segment.c" 2
# 26 "ECU_Layer/7_SEGMENT/ecu_7_segment.c"
Std_ReturnType seven_segment_initialize(const seven_segment_t *_segment)
{
    ...
    {
        ret = gpio_pin_initialize(&(_segment -> segment_pins[0]));
        ret = gpio_pin_initialize(&(_segment -> segment_pins[1]));
        ret = gpio_pin_initialize(&(_segment -> segment_pins[2]));
        ret = gpio_pin_initialize(&(_segment -> segment_pins[3]));
    }

    return ret;
}
# 52 "ECU_Layer/7_SEGMENT/ecu_7_segment.c"
Std_ReturnType seven_segment_write_number(const seven_segment_t *_segment, uint8 number)
{
    Std_ReturnType ret = (Std_ReturnType)0x01;

    if((_segment == ((void*)0)) || (number > 9))
    {
        ret = (Std_ReturnType)0x01;
    }
    else
    {
        ret = gpio_pin_write_logic(&(_segment -> segment_pins[0]), number & 0X01);
        ret = gpio_pin_write_logic(&(_segment -> segment_pins[0]), (number >> 1) & 0X01);
        ret = gpio_pin_write_logic(&(_segment -> segment_pins[0]), (number >> 2) & 0X01);
        ret = gpio_pin_write_logic(&(_segment -> segment_pins[0]), (number >> 3) & 0X01);
    }
